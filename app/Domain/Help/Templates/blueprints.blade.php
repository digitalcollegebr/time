<div class="center padding-lg">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <p>Blueprints are your chance to make sense of all the data. GTI has a variety of tools and canvases to define your project background via Business Model Canvases, SWOT Analysis or Empathy Maps.<br /><br />
