    ...
    <div class="row onboarding">
        <div class="col-md-12" style="font-size:var(--font-size-l);">
            ...
            <div id="firstLoginContent">
                <p><br />Projects in GTI are collaborative workspaces where you and your team organize, track, and deliver work efficiently. Each project serves as a container for related goals, tasks, milestones, and allows you to monitor progress in one central location. <br /><br />
                    Whether you're managing work, school, or internal personal initiatives, GTI projects provide the structure and tools needed to turn ideas into successful outcomes.
                </p><br />
            </div>
            <br /><br />
            <div class="row">
