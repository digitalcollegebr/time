        ...
        <div class="col-md-12" style="font-size:var(--font-size-l);">
            ...
            <div class="col-md-12" style="font-size:var(--font-size-l);">
                <center>
                    ...
                    <br />
                    <p>GTI is built for minds that work differently. That includes neurodivergent brains, but also anyone who's ever felt like existing tools fight against their natural thinking patterns.</p>
                    <br /> <br />
                    <h1 class="fancyLink">Need a hand?</h1>
                    <p>Our team is here to help you get the most out of GTI. Reach out to your account contact and we'll make sure you have everything you need to turn strategy into execution.</p>
                    <br />
                </center>
